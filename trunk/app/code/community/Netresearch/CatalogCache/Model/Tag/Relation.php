...
/**
 * Rewrite of relation tag model to clean product cache after tagging
 *
 * @category   Netresearch
 * @package    Netresearch_CatalogCache
 * @author     Netresearch <info@netresearch.de>
 */
class Netresearch_CatalogCache_Model_Tag_Relation extends Mage_Tag_Model_Tag_Relation
{
